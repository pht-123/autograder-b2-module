...
from app.models.submission import CaseResult, SubmissionState
from app.modules.exception_module.errors import EvaluationError
from app.modules.static_check_module.checkers import ForbiddenChecker, SyntaxChecker
...
class EvaluationService:
    ...
    async def _evaluate(self, state: SubmissionState) -> None:
        ...
        dynamic = await self._b3.evaluate(
